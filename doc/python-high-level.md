...
[run-state-api]: https://hseag.github.io/evi-test/main/doc/api/python/hse.evidense.run.html#hse.evidense.run.Run.State
...
[run-measure-api]: https://hseag.github.io/evi-test/main/doc/api/python/hse.evidense.run.html#hse.evidense.run.Run.measure
[run-savestate-api]: https://hseag.github.io/evi-test/main/doc/api/python/hse.evidense.run.html#hse.evidense.run.Run.save_state
[run-loadstate-api]: https://hseag.github.io/evi-test/main/doc/api/python/hse.evidense.run.html#hse.evidense.run.Run.load_state
[run-checkempty-api]: https://hseag.github.io/evi-test/main/doc/api/python/hse.evidense.run.html#hse.evidense.run.Run.check_empty
[run-exportascsv-api]: https://hseag.github.io/evi-test/main/doc/api/python/hse.evidense.run.html#hse.evidense.run.Run.export_as_csv
[run-exportaskit-api]: https://hseag.github.io/evi-test/main/doc/api/python/hse.evidense.run.html#hse.evidense.run.Run.export_as_kit
[run-importkit-api]: https://hseag.github.io/evi-test/main/doc/api/python/hse.evidense.run.html#hse.evidense.run.Run.import_kit
