...
```bash
python -m pip install https://hseag.github.io/evi-test/main/api/python/dist/hse_evidense-0.10.0-py3-none-any.whl
```

If the OT-2 has no internet connection, download the wheel file [hse_evidense-0.10.0-py3-none-any.whl](https://hseag.github.io/evi-test/main/api/python/dist/hse_evidense-0.10.0-py3-none-any.whl) and copy it to the device with:
...
Install the custom labware [hse_evidense_pilot_right_20ul_tip_v3.json](https://hseag.github.io/evi-test/main/integration_kits/opentrons-ot2/labware/hse_evidense_pilot_right_20ul_tip_v3.json) and the protocol [evidense_demo_v3.py](https://hseag.github.io/evi-test/main/integration_kits/opentrons-ot2/protocol/evidense_demo_v3.py) in the Opentrons App.
